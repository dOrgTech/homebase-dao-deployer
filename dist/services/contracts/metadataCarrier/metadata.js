...
exports.setMetadataJSON = void 0;
const utils_1 = require("../utils");
const setMetadataJSON = ({ description, authors, template, frozenToken: { name: fName, symbol: fSymbol, decimals: fDecimals }, unfrozenToken: { name: uName, symbol: uSymbol, decimals: uDecimals } }) => ({
                                                            ...
                                                            [
                                                                {
                                                                    args: [
                                                                        ...
                                                                        {
                                                                            bytes: (0, utils_1.stringToHex)(uDecimals.toString())
                                                                        }
                                                                    ],
                                                                    prim: "Elt"
                                                                },
                                                                {
                                                                    args: [
                                                                        ...
                                                                        {
                                                                            bytes: (0, utils_1.stringToHex)(uName)
                                                                        }
                                                                    ],
                                                                    prim: "Elt"
                                                                },
                                                                {
                                                                    args: [
                                                                        ...
                                                                        {
                                                                            bytes: (0, utils_1.stringToHex)(uSymbol)
                                                                        }
                                                                    ],
                                                                    prim: "Elt"
                                                                }
                                                            ...
                                                            [
                                                                {
                                                                    args: [
                                                                        ...
                                                                        {
                                                                            bytes: (0, utils_1.stringToHex)(fDecimals.toString())
                                                                        }
                                                                    ],
                                                                    prim: "Elt"
                                                                },
                                                                {
                                                                    args: [
                                                                        ...
                                                                        {
                                                                            bytes: (0, utils_1.stringToHex)(fName)
                                                                        }
                                                                    ],
                                                                    prim: "Elt"
                                                                },
                                                                {
                                                                    args: [
                                                                        ...
                                                                        {
                                                                            bytes: (0, utils_1.stringToHex)(fSymbol)
                                                                        }
                                                                    ],
                                                                    prim: "Elt"
                                                                }
...
exports.setMetadataJSON = setMetadataJSON;
